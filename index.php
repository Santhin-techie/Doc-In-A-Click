                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                <td width="30%" style="padding-left:20px" >
                                    <img src="../img1/logo pro.png" alt="" width="100%" style="border-radius:50%">
                                </td>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img1/icons/doctors-hover.svg');"></div>
                                                    </div>
                                                </td>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img1/icons/patients-hover.svg');"></div>
                                                    </div>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="margin-left: 0px;background-image: url('../img1/icons/book-hover.svg');"></div>
                                                    </div>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;padding-top:21px;padding-bottom:21px;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img1/icons/session-iceblue.svg');"></div>
                                                    </div>
                                                </td>
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br><br><br><br>
                                                    <center>
                                                    <img src="../img1/notfound.svg" width="25%">
